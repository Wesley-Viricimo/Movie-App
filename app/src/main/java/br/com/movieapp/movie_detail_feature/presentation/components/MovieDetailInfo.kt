...
fun MovieInfoContent(
    ...
    Row(
        ...
        MovieInfo(name = stringResource(id = R.string.vote_average),
            value = movieDetails?.voteAverage.toString()
        )
        MovieInfo(name = stringResource(id = R.string.duration),
            value = stringResource(
                id = R.string.duration_minutes,
                movieDetails?.duration.toString()
            )
        )
        MovieInfo(name = stringResource(id = R.string.release_date),
